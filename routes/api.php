...
Route::post('/clients/eventos-liquidez', [ClientController::class, 'storeOrUpdateEventsLiquidity']);
Route::get('/clients/eventos-liquidez', [ClientController::class, 'listEventsLiquidity']);
